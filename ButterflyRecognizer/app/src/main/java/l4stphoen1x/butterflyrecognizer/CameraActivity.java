...
public class CameraActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        window.setStatusBarColor(ContextCompat.getColor(CameraActivity.this,R.color.blue));
        Toolbar makeimg_toolbar = findViewById(R.id.makeimg_toolbar);
        prediction_toolbar = findViewById(R.id.prediction_toolbar);
        info_toolbar = findViewById(R.id.info_toolbar);
        setSupportActionBar(makeimg_toolbar);
...
//                .filePath()
                    .onResult(new Action<String>() {
                        ...
                        public void onAction(@NonNull String result) {
                            initEveryThing(ImageUtils.getBitmapByPath(CameraActivity.this,result));
                    ...
                    .onCancel(new Action<String>() {
                        @Override
                        public void onAction(@NonNull String result) {
                            Toast.makeText(CameraActivity.this, R.string.img_canceled, Toast.LENGTH_LONG).show();
                        }
                    })
                    .start();}
        makeimg_toolbar.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Album.camera(CameraActivity.this)
                        .image()
                        .onResult(new Action<String>(){
                            public void onAction(@NonNull String result){
                                initEveryThing(ImageUtils.getBitmapByPath(CameraActivity.this,result));
                        ...
                        .onCancel(new Action<String>(){
                            public void onAction(@NonNull String result){
                                Toast.makeText(CameraActivity.this, getString(R.string.img_canceled), Toast.LENGTH_SHORT).show();}})
                        .start();}});}
    ...
    public void initEveryThing(Bitmap bitmap){
        try{
            ...
            if(results.size()==0){
                Toast.makeText(CameraActivity.this, getString(R.string.image_not_found), Toast.LENGTH_SHORT).show();
            }else{
